...
import { HeartPulse, Activity, TrendingUp, AlertTriangle } from 'lucide-react';
...
const NgoDashboard = () => {
  ...
  if (!data) return <div className="text-center py-12 text-gray-500">Failed to load NGO dashboard</div>;

  const stats = [
    {
      label: 'Total Needs Tracked',
  ...
  return (
    <div className="space-y-8 animate-fade-in-up">
      <header className="mb-10">
        <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight mb-2">NGO Crisis Report</h1>
        <p className="text-slate-500 font-medium">Overview of submitted needs and response progress</p>
      </header>
